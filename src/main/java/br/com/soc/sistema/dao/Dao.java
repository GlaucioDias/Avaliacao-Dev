...
//		StringBuilder urlBuilder = new StringBuilder("jdbc:mysql://localhost:33068/saudeocupacional");
		final String JDBC_DRIVER = "com.mysql.cj.jdbc.Driver";
		final String DB_URL = "jdbc:mysql://localhost:33068/saudeocupacional";
...
//			 con = DriverManager.getConnection(urlBuilder.toString(), "root", "root");
