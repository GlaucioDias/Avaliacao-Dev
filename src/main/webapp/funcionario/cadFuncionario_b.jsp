...
<body class="bg-secondary">
	<s:include value="/includes/topMenu.jsp">
		<s:param name="active">funcionarios</s:param>
	</s:include>
	<div class="container">
		...
		<div class="row">
			<table class="table table-light table-striped align-middle">
				...
				<tfoot class="table-secondary">
					<tr>
						<td colspan="3"><s:url action="novoFuncionarios" var="novo" /> <a
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<span> <s:text name="label.modal.corpo" /> <s:text name="">${exameVo.rowid}</s:text>
					</span>
				</div>
	...
	<script>
		function excluirRegistro(rowid) {
			let deleteLink  = document.getElementById("btnExcluir");
